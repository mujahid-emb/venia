    ...
    apply(compiler) {
        if (this.config.env.phase === 'development') {
            ...
            if (this.config.enableServiceWorkerDebugging) {
                ...
                console.warn(`Emitting no ServiceWorker in development phase. To enable development phase for ServiceWorkers, pass \`enableServiceWorkerDebugging: true\` to the ServiceWorkerPlugin configuration.`);
            }
        } else {
            this.applyWorkbox(compiler);
        }
...
Object.defineProperty(ServiceWorkerPlugin, 'validateOptions', {
    enumerable: true,
    writable: true,
    value: optionsValidator('ServiceWorkerPlugin', {
        'env.phase': 'string',
