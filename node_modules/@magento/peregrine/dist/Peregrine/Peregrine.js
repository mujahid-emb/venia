...
export default function bootstrap({ apiBase, __tmp_webpack_public_path__ }) {
    ...
    if (process.env.NODE_ENV !== 'production' && this instanceof bootstrap) {
        throw new Error('The API for Peregrine has changed. ' + 'Please see the Release Notes on Github ' + 'for instructions to update your application');
    }
    ...
    const Provider = () => createElement(
        ReduxProvider,
        { store: store },
        createElement(MagentoRouter, routerProps)
    );
...
//# sourceMappingURL=Peregrine.js.map